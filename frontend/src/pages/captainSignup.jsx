            ...
            <div>
                ...
                <div className='flex gap-4 mb-5'>
                    <input
                        ...
                        className="bg-[#eeeeee] rounded px-4 py-2 w-1/2 text-lg placeholder:text-base" 
                        required type="text" placeholder='Plate Number' />
                ...
                <p className='text-centre flex flex-row justify-center items-center'>Already have an account? <Link to='/captain-login' className='ml-1 text-blue-600' >Login Here</Link></p>
